...
<!DOCTYPE html>
    ...
    <head>
        ...
        <link rel = "canonical" href = "https://hpe-storage.github.io/hpe_manila_logs/" />
        <meta property = "og:url" content = "https://hpe-storage.github.io/hpe_manila_logs/" />
        <meta property = "og:site_name" content = "HPE Storage CI LOGS" />
        <script type = "application/ld+json">
        {"@type": "WebSite", "headline": "HPE Storage CI LOGS", "url": "https://hpe-storage.github.io/hpe_manila_logs/", "name": "HPE Storage CI LOGS", "@context": "http://schema.org"} </script>
        <!-- End Jekyll SEO tag -->
    </head>
    <body>
     <!-- HEADER -->
            ...
            if '.html' not in i:
                if os.path.isdir(new_path):
                    table_start = table_start + \
                        "<tr><td><a href = 'https://hpe-storage.github.io/hpe_manila_logs/{}/{}.html'>{}</a></td></tr>\n".format(
                    ...
                    if not any([x in new_path for x in ignore_ext]):
                        ...
                        i = i + '.txt'
                    table_start = table_start + \
                        "<tr><td><a href = 'https://hpe-storage.github.io/hpe_manila_logs/{}'>{}</a></td></tr>\n".format(
